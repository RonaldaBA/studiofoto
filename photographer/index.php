...
<section class="section">
  <div class="section-header d-flex justify-content-between align-items-center">
    <h1>
      <i class="fas fa-camera-retro icon-green mr-2"></i>
      Daftar Fotografer
    </h1>
            ...
            <table class="table table-hover w-100" id="table-1">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="delete.php?id_photographer=<?= $data['id_photographer'] ?>"
                       class="btn btn-sm btn-danger btn-icon mb-1"
                       onclick="return confirm('Yakin ingin menghapus data fotografer ini?')">
                      <i class="fas fa-trash"></i>
                    </a>
                    <a href="edit.php?id_photographer=<?= $data['id_photographer'] ?>"
