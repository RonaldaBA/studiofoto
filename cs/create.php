        ...
        <div class="card-body">
          ...
          <form action="./store.php" method="POST">
            ...
            <div class="form-group">
              <label class="form-label">ID Customer Service</label>
              <input type="number" name="id_cs" class="form-control" placeholder="Contoh: 201" required>
            </div>

            <!-- NAMA -->
            <div class="form-group">
              <label class="form-label">Nama Lengkap</label>
              <input type="text" name="nama" class="form-control" placeholder="Nama customer service" required>
            </div>
